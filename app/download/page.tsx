            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              ...
              <div className="bg-componentpage rounded-xl p-8 border-default">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-center w-full px-6 py-3 bg-gray-900 dark:bg-gray-800 text-inverse rounded-lg opacity-60 cursor-not-allowed pointer-events-none">
                  ...
                  <div
                    className="flex items-center justify-center w-full px-6 py-3 border-2 border-default text-secondary rounded-lg opacity-60 cursor-not-allowed pointer-events-none"
                  >
                    Coming Soon
                  </div>
                </div>
              ...
              <div className="bg-componentpage rounded-xl p-8 border-default">
                ...
                <div className="space-y-3">
                  <div
                    className="flex items-center justify-center w-full px-6 py-3 bg-brand text-inverse rounded-lg opacity-60 cursor-not-allowed pointer-events-none"
                  >
                    <svg className="w-6 h-6 mr-2" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M3,20.5V3.5C3,2.91 3.34,2.39 3.84,2.15L13.69,12L3.84,21.85C3.34,21.6 3,21.09 3,20.5M16.81,15.12L6.05,21.34L14.54,12.85L16.81,15.12M20.16,10.81C20.5,11.08 20.75,11.5 20.75,12C20.75,12.5 20.53,12.9 20.18,13.18L17.89,14.5L15.39,12L17.89,9.5L20.16,10.81M6.05,2.66L16.81,8.88L14.54,11.15L6.05,2.66Z" />
                    </svg>
                  ...
                  <a
                    ...
                    className="flex items-center justify-center w-full px-8 py-4 bg-green-600 text-white text-lg font-semibold rounded-lg hover:bg-green-700 transition-colors shadow-lg"
                  >
                    <Download className="w-6 h-6 mr-3" />
                    Download APK (v1.4.3b5)
                  </a>
                </div>
              </div>
            </div>
