...
export default function DownloadPage() {
  return (
    <PageLayout breadcrumbs={[{ label: "Download" }]}>
      ...
      <div className="py-16 bg-default">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              ...
              <div className="bg-card rounded-xl p-8 border border-default">
                ...
                <div className="space-y-3">
                  <Button disabled size="xl" variant="outline" className="w-full opacity-60 cursor-not-allowed">
              ...
              <div className="bg-card rounded-xl p-8 border border-default">
                ...
                <div className="space-y-3">
                  ...
                  <Button asChild size="xl" variant="default" className="w-full">
                    <a href="/downloads/mash-v1.4.3b5.apk">
          ...
          <div>
            ...
            <div className="bg-card rounded-xl p-8 border border-default max-w-4xl mx-auto">
