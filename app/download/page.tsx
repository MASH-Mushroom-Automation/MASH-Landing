            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              ...
              <div className="bg-componentpage rounded-xl p-8 border-default">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-center w-full px-6 py-3 bg-gray-900 dark:bg-gray-800 text-inverse rounded-lg hover:opacity-80 transition-colors">
