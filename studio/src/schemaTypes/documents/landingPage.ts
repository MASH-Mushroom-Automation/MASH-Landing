      ...
      of: [
        {
          ...
          fields: [
            ...
            { name: 'icon', type: 'string', title: 'Icon Name' },
            { name: 'color', type: 'string', title: 'Accent Color', description: 'Tailwind bg color class (e.g., bg-green-600, bg-blue-600)' },
            { name: 'features', type: 'array', title: 'Screen Features', of: [{ type: 'string' }] },
            {
              name: 'screenshot',
              type: 'image',
              title: 'App Screenshot',
              description: 'Screenshot of the actual mobile app screen',
