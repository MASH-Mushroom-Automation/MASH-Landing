      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <Card className="border border-white/20 text-white bg-transparent hover:shadow-2xl transition-all transform hover:scale-105 h-full">
              <CardContent className="p-8">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <div className="text-sm text-white">Coming Soon on the</div>
        ...
        <ScrollReveal>
          <div className="mt-12 text-center">
            ...
            <Button asChild size="xl" variant="secondary" className="bg-white text-green-600 hover:bg-gray-100 font-semibold">
              <Link href="/download">
